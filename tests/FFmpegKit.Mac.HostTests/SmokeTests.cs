...
/// <summary>A single check against the packed package. Throws to fail.</summary>
...
/// <summary>
/// End-to-end checks against the packed package: they load the native FFmpeg libraries out of the
/// packaged xcframeworks and run actual FFmpeg commands - directly on the host Mac, which is the
/// target platform, so no simulator or device is involved.
/// </summary>
