...
namespace Ffmpegkit.Mac
{
	public partial class FFmpegKitConfig
	{
		/// <summary>The current log level, as the <see cref="Ffmpegkit.Mac.Level"/> enum.</summary>
		/// <remarks>
	...
	public static class FFmpegKitExtensions
	{
		...
		/// <summary>The severity of this log line, as the <see cref="Ffmpegkit.Mac.Level"/> enum.</summary>
		/// <remarks>
